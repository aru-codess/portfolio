...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Anurup Bhowmick",
    description: `Full-stack developer specializing in backend technologies, scalable systems, and performance optimization.`,
  ...
  return (
    <>
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">anurup</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <ul className="flex min-h-fit w-full flex-col items-start space-y-6 px-[22px] py-[58px]">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 text-xl transition hover:text-primary"
                    title={isDark ? "Light mode" : "Dark mode"}
                  >
